...
public class CShadowSprite : CGameObject
{
    ...
    private float deathRedux = 5;
    public CShadowSprite(float DeathDecreaseFactor)
    {
        deathRedux = DeathDecreaseFactor;
